...
void indexHtml(AsyncWebServerRequest &request, const String &extra_pre_html = "", const String &extra_post_html = "")
{
    ...
    String html{
        ...
        "mm move distance<br/>\n"
        "    <input type='number' id='feed_rate_mm_s2' step='10' value='200' min='10' max='500' size='4'></input> "
        "mm/s² feed rate\n"
        "    <br/>\n"
        "    Distance mode: \n"
        ...
        "        })\n"
        "\n"
        "      function getFeedRate() { return parseFloat(document.getElementById('feed_rate_mm_s2').value) }\n"
